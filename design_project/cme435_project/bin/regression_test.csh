...
if ($#argv == 1) then
  if ("$argv[1]" == "-cc") then
	...
	vlog dut/*.svp dut/*.sv
	vlog +cover +acc +incdir+verification/regression_test verification/regression_test/driver.sv
	vlog +cover +acc +incdir+verification/regression_test verification/regression_test/environment.sv
	vlog +cover +acc +incdir+verification/regression_test verification/regression_test/generator.sv
	vlog +cover +acc +incdir+verification/regression_test verification/regression_test/interface.sv
	vlog +cover +acc +incdir+verification/regression_test verification/regression_test/TransBase.sv
	vlog +cover +acc +incdir+verification/regression_test verification/regression_test/monitor.sv
	vlog +cover +acc +incdir+verification/regression_test verification/regression_test/scoreboard.sv
	vlog +cover +acc +incdir+verification/regression_test verification/regression_test/tbench_top.sv

	foreach testcase ($testcase_list)
		vlog +cover +acc +incdir+verification/regression_test verification/regression_test/testbench_$testcase.sv
