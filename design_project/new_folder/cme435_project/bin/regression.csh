...
if ($#argv == 2) then
  if ("$argv[1]" == "-t") then
    ...
    rm -r work transcript *.vcd *.wlf ../report/regression*
    ...
    vsim -coverage tbench_top -c -do "coverage save -onexit ../report/regression_$argv[2].ucdb; run -all; exit"

    vcover report -details ../report/regression_$argv[2].ucdb -file ../report/regression_$argv[2].rpt
    vcover report -html ../report/regression_$argv[2].ucdb -htmldir ../report/regression_$argv[2]
  endif
endif
